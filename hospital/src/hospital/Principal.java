...
public class Principal {
    ...
    public static void main(String[] args){
        ...
        for(int i = 0; i<cantidadCorridas; i++){
            ...
            queueEspecialista1.reiniciarCola();
            queueEspecialista2.reiniciarCola();
            queueGeneral.reiniciarCola();
            queueResidente1.reiniciarCola();
            queueResidente2.reiniciarCola();
            
            servidorEspecialista1.reiniciarEstadisticas();
            servidorEspecialista2.reiniciarEstadisticas();
            servidorGeneral.reiniciarEstadisticas();
            servidorResidente1.reiniciarEstadisticas();
            servidorResidente2.reiniciarEstadisticas();
            
            Fel.getFel().getLista().clear();
        }
